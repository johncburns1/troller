...
class IssueResolutionWorkflow:
    ...
    def __init__(self) -> None:
        ...
        self._plan: PlanOutput | None = None
        self._pr_body_builder = PRBodyBuilder()
    ...
    async def run(
        ...
        # Store plan for PR body generation
        ...
        pr_body = self._pr_body_builder.build(self._issue, self._plan, self._commits)
